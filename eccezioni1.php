...
<html>
    <head>
	    ...
	    <h2 style="text-align: center;"><b>Visualizzazione eccezioni</b></h2>
            <p style="text-align: center;">Per visualizzare le eccezioni, inserire la partita iva del cliente.
            </p>
	    <div style="text-align: center;">
            <form action="eccezioni.php" method="post">
