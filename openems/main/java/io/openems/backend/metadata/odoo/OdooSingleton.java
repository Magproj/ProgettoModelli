...
public class OdooSingleton implements MetadataSingleton {
	 ...
	 */
	@Override
	public void getInfoWithSession(BrowserSession sessionn) throws OpenemsException, ClassCastException {
		HttpURLConnection connection = null;
		try {
			// get session_id from Session
			SessionData sessionData = sessionn.getData();
			
			//se sessionData non è di tipo BrowserSessionData verrà sollevata un'eccezione
			...
			String line = null;
			BufferedReader riga=br.readLine();
			while ((line = riga) != null) {
