...
public class BalancingBandgapReactivePowerController extends Controller {
	...
	public void run() {
		try {
			...
			calculatedPowers[0] = setCalcReactive(calculatedPowers[0], maxReactivePowerL1.value(), minReactivePowerL1.value());
			
			calculatedPowers[1] = setCalcReactive(calculatedPowers[1], maxReactivePowerL2.value(), minReactivePowerL2.value());
			
			calculatedPowers[2] = setCalcReactive(calculatedPowers[2], maxReactivePowerL3.value(), minReactivePowerL3.value());
	...
	private long setCalcReactive(long calcPower, long valueMax, long valueMin){
