...
<?php
    ...
    if($conta==1){
        ...
        echo "I dati dell'adattatore cercato sono i seguenti: <br><br>";
        
        $id = mysql_result($result, 0, "id");
        echo 'Identificatore:  ' . $id . ' </br>';
        $stato = mysql_result($result, 0, "stato");
        if($stato){
            echo 'Stato: Attivo <a href="modificaStatoAdatt.html">Edit</a></br>';
        } else{
            echo 'Stato: Non attivo <a href="modificaStatoAdatt.html">Edit</a></br>';
        }
        $idsensore = mysql_result($result, 0, "id_sensore");
        echo 'Identificatore sensore: ' . $idsensore . ' <a href="modificaSensoreAdatt.html">Edit</a></br>';
    
    } else {
        echo "L'adattatore non e' stato trovato.";
    }
