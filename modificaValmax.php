...
<?php
    ...
    //comando SQL
    $sql1 = sprintf("UPDATE modellostringa SET valmax='%s' WHERE tipo='%s' AND id_impianto='%s'", mysqli_real_escape_string($mysqli, $valmax), mysqli_real_escape_string($mysqli, $tipo), mysqli_real_escape_string($mysqli, $idimpianto));
