...
public class ComponentSingleton {
	...
	protected static synchronized Component getComponent(ConfigChannel<Integer> portt, ApiWorker apiWorkerr) throws OpenemsException {
	...
	protected static synchronized Component getComponent(int portt, ApiWorker apiWorkerr) throws OpenemsException {
	...
	protected static synchronized void restartComponent(int portt, ApiWorker apiWorkerr) throws OpenemsException {
		stopComponent();
		startComponent(portt, apiWorkerr);
	}

	private static synchronized void startComponent(int portt, ApiWorker apiWorkerr) throws OpenemsException {
