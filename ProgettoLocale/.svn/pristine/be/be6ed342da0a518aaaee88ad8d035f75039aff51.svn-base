...
interface Handler<T extends Object> {
	  JsonElement castType(Object value);
	}

private class NumberHandler implements Handler<Number>{
	
	@Override
	public JsonElement castType(Number arg0) {
...
private class StringHandler implements Handler<String>{
	...
	public JsonElement castType(String value){
...
private class BooleanHandler implements Handler<Boolean>{
	...
	public JsonElement castType(Boolean value){
...
private class Inet4AddressHandler implements Handler<Inet4Address>{
	...
	public JsonElement castType(Inet4Address value){
...
private class JsonElementHandler implements Handler<JsonElement>{
	...
	public JsonElement castType(JsonElement value){
...
private class LongHandler implements Handler <Long[]>{
	...
	public JsonElement castType(Long[] value){
...
public class JsonUtils {
	...
	public static JsonElement parse(String string) throws OpenemsException {
		try {
			...
			throw new OpenemsException("Unable to parse [" + string + "] + to JSON: " + " Something was wrong");
		}
	}
	...
	public static JsonElement getAsJsonElement(Object value) throws NotImplementedException {
		...
		// dispatch based on a simple map
		  ...
		  if(h != null) return h.castTyper(value);
		  else	throw new NotImplementedException("Converter for [" + value + "]" + " of type [" //
