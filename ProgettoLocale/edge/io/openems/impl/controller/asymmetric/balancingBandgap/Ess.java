...
public class Ess extends ThingMap {
	/**
	* constant ReadChannel<Long> soc
	*/
	public ReadChannel<Long> soc;
	/**
	* constant ReadChannel<Long> activePowerLl
	*/
	public ReadChannel<Long> activePowerL1;
	/**
	* constant ReadChannel<Long> activePowerL2
	*/
	public ReadChannel<Long> activePowerL2;
	/**
	* constant ReadChannel<Long> activePowerL3
	*/
	public ReadChannel<Long> activePowerL3;
	/**
	* constant ReadChannel<Long> reactivePowerL1
	*/
	public ReadChannel<Long> reactivePowerL1;
	/**
	* constant ReadChannel<Long> reactivePowerL2
	*/
	public ReadChannel<Long> reactivePowerL2;
	/**
	* constant ReadChannel<Long> reactivePowerL3
	*/
	public ReadChannel<Long> reactivePowerL3;
	/**
	* constant ReadChannel<Long> allowedCharge
	*/
	public ReadChannel<Long> allowedCharge;
	/**
	* constant ReadChannel<Long> allowedDischarge
	*/
	public ReadChannel<Long> allowedDischarge;
	/**
	* constant ReadChannel<Long> minSoc
	*/
	public ReadChannel<Integer> minSoc;
	/**
	* constant WriteChannel<Long> setWorkState
	*/
	public WriteChannel<Long> setWorkState;
	/**
	* constant WriteChannel<Long> setActivePowerLl
	*/
	public WriteChannel<Long> setActivePowerL1;
	/**
	* constant WriteChannel<Long> setActivePowerL2
	*/
	public WriteChannel<Long> setActivePowerL2;
	/**
	* constant WriteChannel<Long> setActivePowerL3
	*/
	public WriteChannel<Long> setActivePowerL3;
	/**
	* constant WriteChannel<Long> setReactivePowerL1
	*/
	public WriteChannel<Long> setReactivePowerL1;
	/**
	* constant WriteChannel<Long> setReactivePowerL2
	*/
	public WriteChannel<Long> setReactivePowerL2;
	/**
	* constant WriteChannel<Long> setReactivePowerL3
	*/
	public WriteChannel<Long> setReactivePowerL3;
	/**
	* constant ReadChannel<Long> allowedApparent
	*/
